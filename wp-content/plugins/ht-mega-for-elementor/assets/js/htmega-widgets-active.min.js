(function ($) {
  ...
  var WidgetHtmegaCarouselHandler = function ($scope, $) {
    ...
    if (carousel_elem.length > 0) {
      ...
      if (
        ...
        var maxHeight = -1;
        $(
          "." + settings.sectionid + " " + settings.equal_height_column_class
        ).each(function () {
          if (
            $(
              "." +
  ...
  var WidgetGoogleMapHandler = function ($scope, $) {
    ...
    if (googlemap_elem.length > 0) {
      ...
      var myMarkers = { markers: mapsettings };
  ...
  var WidgetAccordionsMapHandler = function ($scope, $) {
    ...
    if (accordion_elem.length > 0) {
      $("#accordion-4 > li").hover(
        function () {
          var $this = $(this);
          $this.stop().animate({ width: "430px" }, 500);
        ...
        function () {
          var $this = $(this);
          $this.stop().animate({ width: "130px" }, 1000);
  ...
  var WidgetLightboxHandler = function ($scope, $) {
    ...
    if (lightbox_elem.length > 0) {
      ...
      lightbox_elem.magnificPopup({
        ...
        image: { verticalFit: !0, titleSrc: "This is title" },
      });
    }
  };
  var WidgetVideoPlayerHandler = function ($scope, $) {
    ...
    if (videotype.videocontainer == "self") {
      ...
      videopopup_elem.magnificPopup({ type: "iframe" });
    }
  };
  var WidgetTooltipHandler = function ($scope, $) {
    $('[data-toggle="tooltip"]').htbtooltip({ animation: !1 });
  };
      ...
      $(notify_opt.notify_btn_class).on("click", function () {
        $.notify(
          {},
          {
            ...
            placement: { from: notify_opt.from, align: notify_opt.align },
    ...
    if (masonry_elem.length > 0) {
      masonry_elem.imagesLoaded(function () {
        ...
        $(".masonry-wrap").isotope({
          ...
          masonry: { columnWidth: ".masonary-sizer" },
        });
      });
    }
  };
  var WidgetNavigationScrollHandler = function ($scope, $) {
    ...
    var swiper = new Swiper(swiper_elem[0], {
      ...
      keyboard: { enabled: swiper_opt.keyboardscroll, onlyInViewport: !1 },
      breakpoints: {
        [tablet_width]: { direction: swiper_opt.tablet_direction },
        [mobile_width]: { direction: swiper_opt.mobile_direction },
      },
    });
